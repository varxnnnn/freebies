...
class _HomePageState extends State<HomePage> {
  ...
  // ❌ All other dummy data REMOVED from state (but kept in build for UI structure)
  // We'll define them inside build() to avoid state bloat
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            switch (cat["name"]) {
                              case "Quizzes":
                                targetPage = const QuizzesPage();
                                break;
                              case "Surveys":
                                targetPage = const SurveysPage();
                                break;
                              case "Watch Ads":
                              case "Offers":
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      color: card["bgColor"] as Color, // cast dynamic to Color
      ...
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: card["bgColor"] as Color, // cast here
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(8),
            ),
          ),
          child: Text(
            card["buttonText"] as String, // cast here
            style: TextStyle(
              color: card["bgColor"] as Color, // cast here too
              fontWeight: FontWeight.bold,
            ),
          ),
        ),
                ...
                // Ongoing Tasks Section (dummy UI only)
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
