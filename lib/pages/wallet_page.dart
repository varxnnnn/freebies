...
import 'package:projectx/providers/wallet_provider.dart'; // ✅ Adjust if path differs
...
class _WalletScreenState extends State<WalletScreen> {
  // Remove dummy _walletBalance — we'll use provider instead
  ...
  final List<Map<String, dynamic>> _rewards = [
    {
      ...
      'image': 'https://via.placeholder.com/40/4ECDC4/FFFFFF?text=N'
    },
    {
      'title': 'Netflix 1 Month Subscription',
      'image': 'https://via.placeholder.com/40/4ECDC4/FFFFFF?text=N'
